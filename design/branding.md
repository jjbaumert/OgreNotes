...
Document-level typography themes:
...
| Concept | OgreNotes Term |
|---------|----------------|
| Document / messaging primitive | Document / Chat |
| Default landing folder | Home |
| Message pane on a document | Comments |
| Per-paragraph inline menu | Block Menu |
| Searchable command list | Command Palette |
| Embedded interactive blocks | Embeds |
| Bookmark / favorite | Pin |
