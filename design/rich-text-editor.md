...
Our implementation diverges from these where noted (see `mvp-detailed-design.md`
for the actual MVP keymap).
...
**Implementation notes (where our bindings diverge from ProseMirror):**
