...
> **Numbering note (2026-05-05):** the project roadmap reserves
> **Phase 6** for this RAG / agentic-search track (see
> `high-level-design.md` Build Phases). The internal milestones below
> are numbered **Phase 6.1 through 6.4** so they slot cleanly under
> the project numbering. Older revisions of this doc used "Phase 1–4";
> the renumbering is editorial — no scope changed.
...
### Phase 6.2 — Graph Index (Weeks 4–6)
...
### Phase 6.3 — Agentic Layer (Weeks 7–9)
...
### Phase 6.4 — Validation & Tuning (Weeks 10–12)
