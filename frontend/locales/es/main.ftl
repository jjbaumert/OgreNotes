...
menu-copy-original-url = Copiar URL original
menu-convert-to-plain-link = Convertir en enlace normal
menu-bold = Negrita
menu-italic = Cursiva
...
doc-mention-missing = Documento no disponible
...
quip-import-menu-entry = Importar desde Quip…
quip-import-title = Importar desde Quip
quip-import-token-label = Token de la API de Quip
quip-import-token-placeholder = Pega tu token de acceso personal de Quip
quip-import-token-hint = ¿No tienes un token?
quip-import-token-hint-link = Consíguelo en Quip
quip-import-connect = Conectar
quip-import-connecting = Conectando…
quip-import-error = No se pudo conectar: { $err }
quip-import-profile = Conectado como { $name }
quip-import-folder-scope-heading = Elige las carpetas a importar
quip-import-no-folders = No se encontraron carpetas en esta cuenta de Quip.
quip-import-continue = Continuar
quip-import-target-home = Los documentos se importarán a una nueva carpeta Quip Import dentro de tu carpeta de Inicio.
quip-import-target-folder = Los documentos se importarán a una nueva carpeta Quip Import dentro de { $folder }.
quip-import-destination-change = Cambiar
quip-import-destination-heading = Elige dónde importar
quip-import-destination-hint = Elige la carpeta de destino. Dentro de ella se creará una nueva carpeta Quip Import, así puedes deshacer toda la importación eliminando esa única carpeta.
quip-import-destination-select = Usar esta carpeta
quip-import-starting = Iniciando importación…
quip-import-scanning = Explorando Quip… se encontraron { $total } elementos
quip-import-inventory-done = Se encontraron { $total } elementos para importar
...
quip-import-report-imported = Se importaron { $imported } documentos
quip-import-report-skipped = { $count } omitidos: no tienes acceso en Quip
quip-import-report-failed = No se pudieron importar { $count }
quip-import-report-and-more = …y { $count } más
quip-import-report-chat = { $count } conversaciones de chat no se importaron: los chats no son documentos
quip-import-report-note = { $id } — { $detail }
quip-import-report-note-general = { $detail }
quip-import-report-within-heading = Estos documentos se importaron, pero parte de su contenido no se pudo trasladar
quip-import-report-images = No se pudieron copiar { $count } imágenes desde Quip
quip-import-report-truncated = En { $count } documentos se aplanó el contenido con anidamiento profundo
