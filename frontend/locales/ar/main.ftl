...
quip-import-token-hint = تحتاج إلى رمز؟
quip-import-token-hint-link = احصل عليه من Quip
...
quip-import-target-home = سيتم استيراد المستندات إلى مجلد Quip Import جديد داخل مجلد الرئيسية الخاص بك.
quip-import-target-folder = سيتم استيراد المستندات إلى مجلد Quip Import جديد داخل { $folder }.
quip-import-destination-change = تغيير
quip-import-destination-heading = اختر وجهة الاستيراد
quip-import-destination-hint = اختر المجلد الذي تريد الاستيراد إليه. سيتم إنشاء مجلد Quip Import جديد بداخله، بحيث يمكنك التراجع عن الاستيراد بالكامل بحذف هذا المجلد وحده.
quip-import-destination-select = استخدام هذا المجلد
quip-import-starting = جارٍ بدء الاستيراد…
quip-import-scanning = جارٍ فحص Quip… تم العثور على { $total } عنصر
quip-import-inventory-done = تم العثور على { $total } عنصر للاستيراد
...
quip-import-report-imported = تم استيراد { $imported } مستند
quip-import-report-skipped = تم تخطي { $count } — ليس لديك حق الوصول في Quip
quip-import-report-failed = تعذر استيراد { $count }
quip-import-report-and-more = …و{ $count } أخرى
quip-import-report-chat = لم يتم استيراد { $count } محادثة — المحادثات ليست مستندات
quip-import-report-note = { $id } — { $detail }
quip-import-report-note-general = { $detail }
quip-import-report-within-heading = تم استيراد هذه المستندات، لكن بعض المحتوى بداخلها لم يُنقل
quip-import-report-images = تعذّر نسخ { $count } صورة من Quip
quip-import-report-truncated = في { $count } مستند تم تسطيح المحتوى العميق التداخل
