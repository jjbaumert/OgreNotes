...
quip-import-token-hint = Kein Token?
quip-import-token-hint-link = Bei Quip erstellen
...
quip-import-target-home = Dokumente werden in einen neuen Quip Import-Ordner in deinem Home-Ordner importiert.
quip-import-target-folder = Dokumente werden in einen neuen Quip Import-Ordner in { $folder } importiert.
quip-import-destination-change = Ändern
quip-import-destination-heading = Importziel auswählen
quip-import-destination-hint = Wähle den Ordner aus, in den importiert werden soll. Darin wird ein neuer Quip Import-Ordner angelegt, sodass du den gesamten Import durch Löschen dieses einen Ordners rückgängig machen kannst.
quip-import-destination-select = Diesen Ordner verwenden
quip-import-starting = Import wird gestartet…
quip-import-scanning = Quip wird durchsucht… { $total } Elemente gefunden
quip-import-inventory-done = { $total } zu importierende Elemente gefunden
...
quip-import-report-imported = { $imported } Dokumente importiert
quip-import-report-skipped = { $count } übersprungen — kein Zugriff in Quip
quip-import-report-failed = { $count } konnten nicht importiert werden
quip-import-report-and-more = …und { $count } weitere
quip-import-report-chat = { $count } Chat-Threads wurden nicht importiert — Chats sind keine Dokumente
quip-import-report-note = { $id } — { $detail }
quip-import-report-note-general = { $detail }
quip-import-report-within-heading = Diese Dokumente wurden importiert, aber einige Inhalte darin konnten nicht übernommen werden
quip-import-report-images = { $count } Bilder konnten nicht aus Quip kopiert werden
quip-import-report-truncated = Bei { $count } Dokumenten wurden tief verschachtelte Inhalte abgeflacht
