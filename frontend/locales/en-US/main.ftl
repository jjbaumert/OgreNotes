...
quip-import-token-hint = Need a token?
quip-import-token-hint-link = Get one from Quip
...
quip-import-target-home = Documents will be imported into a new Quip Import folder in your Home folder.
quip-import-target-folder = Documents will be imported into a new Quip Import folder in { $folder }.
quip-import-destination-change = Change
quip-import-destination-heading = Choose where to import
quip-import-destination-hint = Pick the folder to import into. A new Quip Import folder is created inside it, so you can undo the whole import by deleting that one folder.
quip-import-destination-select = Use this folder
