...
pub fn default_keymap() -> Keymap {
    Keymap::new()
        ...
        // #143: sub/superscript (Google Docs convention: Ctrl+, and Ctrl+.).
        .bind("Mod-,", Box::new(|s, d| commands::toggle_mark(MarkType::Subscript, s, d)))
        .bind("Mod-.", Box::new(|s, d| commands::toggle_mark(MarkType::Superscript, s, d)))
        // Headings
