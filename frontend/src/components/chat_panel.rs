...
pub fn ChatPanel() -> impl IntoView {
    ...
    view! {
        <div class="sidebar-section">
            ...
            >
                <span class="sidebar-section-title">{crate::t!("chat-section-title")}</span>
            ...
            <Show when=move || expanded.get()>
                <div class="sidebar-section-body">
                    ...
                    <Show when=move || selected_chat.get().is_some()>
                        ...
                        >{crate::t!("chat-back")}</button>
                    </Show>

                    // Chat list view.
                    <Show when=move || selected_chat.get().is_none()>
                        <Show when=move || loading.get()>
                            <div class="sidebar-loading">{crate::t!("common-loading")}</div>
                        </Show>
                        {move || {
                            let items = chat_list.get();
                            if items.is_empty() && !loading.get() {
                                view! {
                                    <div class="sidebar-empty">{crate::t!("chat-empty")}</div>
                                }.into_any()
                            } else {
                                view! {
                                    <div class="chat-list">
                    ...
                    <Show when=move || selected_chat.get().is_some()>
                        ...
                        <div class="chat-input">
                            <input
                                ...
                                placeholder=crate::t!("chat-message-placeholder")
