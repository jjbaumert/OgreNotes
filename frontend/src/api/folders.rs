...
pub struct FolderResponse {
    ...
    pub created_at: i64,
    pub updated_at: i64,
    /// True when this is the caller's Trash folder. Unlocks trash-mode
    /// rendering (inline Restore / Delete-forever actions per row).
    #[serde(default)]
    pub is_trash: bool,
...
pub struct ChildResponse {
    ...
    pub title: String,
    pub added_at: i64,
    /// Only non-false for doc children surfaced in the Trash folder listing.
    #[serde(default)]
    pub is_deleted: bool,
}
